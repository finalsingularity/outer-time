scoreboard players set outer.seed outer.math 0
scoreboard players set outer.multiplier outer.math 75
scoreboard players set outer.increment outer.math 74
scoreboard players set outer.iteration outer.math 0
