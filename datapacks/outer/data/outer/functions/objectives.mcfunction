...
scoreboard objectives add outer.ruby dummy
scoreboard objectives add outer.topaz dummy
scoreboard objectives add outer.emerald dummy
scoreboard objectives add outer.sapphire dummy

# Item Temp
scoreboard objectives add outer.temp.gold dummy
scoreboard objectives add outer.temp.ruby dummy
scoreboard objectives add outer.temp.topaz dummy
scoreboard objectives add outer.temp.emerald dummy
...
# Bazaar
scoreboard objectives add outer.bazaar.casino dummy

# Generation
scoreboard objectives add outer.generation dummy